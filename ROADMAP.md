...
- **1.12 Three-mode display system** — spec locked 2026-05-23 (`sessions/2026-05-23-phase-1.12-spec.md`); **build steps 1–3 (infrastructure + picker + Plain skin) shipped 2026-05-23 (`sessions/2026-05-23-phase-1.12-foundation.md`) — awaiting live verification; prototype-gated steps 4–6 (Fancy enhancements, Reader skin, Fancy mobile) remain.** Replaces binary plain/pasture with three descriptively-named modes:
