...
- **Admin tag taxonomy mobile polish** (2026-05-24) — tag rows on `/admin/featured` are usable on mobile but still cramped; category head 3-row stack shipped but tag table card layout could be tighter. Low priority — taxonomy is rarely edited. Revisit if the page sees heavy use.
