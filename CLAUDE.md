...
**PHASE: Live — post-launch, Phase 2 in progress (updated 2026-09-15)**
...
**This session (2026-09-10) — Phase 2.5.1 design sprint, step 1: parts template + posing harness (prototypes only, nothing deployed changes):**
- `prototypes/horse-parts-template.svg` — the 10 posable pieces cut from the live 2.4 horse (neutral pose = today's horse), `PIVOTS` layer (`pv-*`, cap radius in `data-cap`), 4 rough warped tails, ground `y=344.5` (spec amended from 342 — see its Drawing rules). Generated by `prototypes/horse-parts-cut.py`, which also refreshes the harness's built-in copies.
